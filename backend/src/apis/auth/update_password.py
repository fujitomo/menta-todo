...
from constants.other import COLLLECTION, ERROR_MESSAGE, REGISTRANT, SUCCESS_MESSAGE
...
async def endpoint(
    ...
    # bcryptで古いパスワードを検証
    if not AuthFuncs.verify_password(
        request_model.old_password, old_password[REGISTRANT.PASSWORD]
    ):
